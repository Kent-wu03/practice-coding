...
page.innerHTML = "REGISTER/LOGIN PAGE";

function onregister() {
    if (localStorage.getItem("username") == null && usernameinput.value != "" && passinput.value != "") {
        localStorage.setItem("username",usernameinput.value)
    }else {
        alert("tidak ada username/password")
    }
}
